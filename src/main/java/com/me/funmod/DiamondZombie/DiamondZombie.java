...
public class DiamondZombie extends ZombieEntity {
    ...
    public class Effect {
        ...
        public Effect(ParticleEffect type, BlockPos pos, float duration) {
            this.type = type;
            this.pos = pos;
            this.duration = duration;
        }
        public CompoundTag toTag(CompoundTag tag) {
            tag.putString("effect", this.type.toString());
            tag.putString("pos", this.pos.toString());
            tag.putFloat("duration", this.duration);
            return tag;
        }

        //public Effect fromTag(CompoundTag tag) {
        //    return new Effect();
        //}
    }
    ...
    public void addEffect(ParticleEffect params, BlockPos pos, float duration) {
