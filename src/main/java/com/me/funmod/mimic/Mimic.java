...
import com.me.funmod.ai.MimicIgniteGoal;
...
import java.util.Iterator;
 ...
 public class Mimic extends HostileEntity implements SkinOverlayOwner {
        ...
        public Mimic(EntityType<? extends Mimic> entityType, World world) {
            super(entityType, world);
        }

        protected void initGoals() {
            this.goalSelector.add(1, new SwimGoal(this));
            this.goalSelector.add(2, new MimicIgniteGoal(this));
        ...
        public static DefaultAttributeContainer.Builder createMimicAttributes() {
            return HostileEntity.createHostileAttributes().add(EntityAttributes.GENERIC_MAX_HEALTH, 5);
        ...
        protected void dropEquipment(DamageSource source, int lootingMultiplier, boolean allowDrops) {
            ...
            if (entity != this && entity instanceof Mimic) {
                Mimic mimicEntity = (Mimic)entity;
                if (mimicEntity.shouldDropHead()) {
                    mimicEntity.onHeadDropped();
        ...
        static {
            FUSE_SPEED = DataTracker.registerData(Mimic.class, TrackedDataHandlerRegistry.INTEGER);
            CHARGED = DataTracker.registerData(Mimic.class, TrackedDataHandlerRegistry.BOOLEAN);
            IGNITED = DataTracker.registerData(Mimic.class, TrackedDataHandlerRegistry.BOOLEAN);
        }
}
